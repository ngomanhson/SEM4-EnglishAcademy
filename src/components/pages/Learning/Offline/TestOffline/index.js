...
function TestOffline() {
    ...
    const handleSubmitTest = useCallback(async () => {
        try {
            ...
            const response = await api.post(url.ONLINE_COURSE.SUBMIT_TEST + `/${slug}`, dataSubmit, {
                headers: {
                    Authorization: `Bearer ${getAccessToken()}`,
                },
            });
    ...
    }, [navigate, selectedAnswers, startTime, slug, testData]);
                                                                            ...
                                                                            {fileSubmit && (
                                                                                <button type="button" className="rbt-btn bg-primary-opacity btn-not__hover btn-not__hover w-100 mt-4" disabled>
                                                                                    <div className="d-flex align-items-center justify-content-center">
                                                                                        Processing in progress <div className="dot-loader"></div>
                                                                                    </div>
                                                                                </button>
                                                                            )}
                                                                        </div>
