                            ...
                            <div className="rbt-team team-style-default style-three small-layout rbt-hover">
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <h6 className="subtitle theme-gradient">Math Teacher</h6>
                            ...
                            <div className="rbt-team team-style-default style-three small-layout rbt-hover">
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <h6 className="subtitle theme-gradient">Depertment Head</h6>
                                        <span className="team-form">
                                            <i className="feather-map-pin"></i>
                                            <span className="location">CO Miego, AD,USA</span>
                                        </span>
                            ...
                            <div className="rbt-team team-style-default style-three small-layout rbt-hover">
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <h6 className="subtitle theme-gradient">Teacher</h6>
                                        <span className="team-form">
                                            <i className="feather-map-pin"></i>
                                            <span className="location">CO Miego, AD,USA</span>
                                        </span>
                            ...
                            <div className="rbt-team team-style-default style-three small-layout rbt-hover">
                                <div className="inner">
                                    ...
                                    <div className="content">
                                        ...
                                        <h6 className="subtitle theme-gradient">Economic</h6>
                                        <span className="team-form">
                                            <i className="feather-map-pin"></i>
                                            <span className="location">CO Miego, AD,USA</span>
                                        </span>
