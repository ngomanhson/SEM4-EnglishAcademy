...
function VideoLesson(props) {
    ...
    return (
        <div className="plyr plyr--full-ui plyr--video plyr--youtube plyr--fullscreen-enabled plyr--paused plyr--stopped plyr__poster-enabled">
            <div className="plyr__controls">
                <button type="button" className="plyr__controls__item plyr__control" onClick={handlePlayPause}>
