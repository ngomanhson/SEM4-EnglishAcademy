                                                    ...
                                                    <div className="single-progress">
                                                        ...
                                                        <div className="progress">
                                                            <div
                                                                ...
                                                                data-wow-delay=".3s"
                                                                role="progressbar"
                                                                style={{ width: "40%", visibility: "visible", animationDuration: "0.5s", animationDelay: "0.3s", animationName: "fadeInLeft" }}
                                                                aria-valuenow="40"
                                                                aria-valuemin="0"
                                                                aria-valuemax="100"
                                                            ></div>
                                                    ...
                                                    <div className="single-progress">
                                                        ...
                                                        <div className="progress">
                                                            <div
                                                                ...
                                                                data-wow-delay=".3s"
                                                                role="progressbar"
                                                                style={{ width: "65%", visibility: "visible", animationDuration: "0.5s", animationDelay: "0.3s", animationName: "fadeInLeft" }}
                                                                aria-valuenow="65"
                                                                aria-valuemin="0"
                                                                aria-valuemax="100"
                                                            ></div>
