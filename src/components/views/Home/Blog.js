        ...
        <div className="rbt-rbt-blog-area rbt-section-gap">
            <div className="container">
                ...
                <div className="row row--15">
                    <div className="col-lg-6 col-md-12 col-sm-12 col-12 mt--30 sal-animate" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div className="rbt-card variation-02 height-330 rbt-hover">
                            ...
                            <div className="rbt-card-body">
                                ...
                                <div className="rbt-card-bottom">
                                    <a className="transparent-button" href="blog-details.html">
                                        Learn More
                                        <i>
                    ...
                    <div className="col-lg-6 col-md-12 col-sm-12 col-12 mt--30 sal-animate" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div className="rbt-card card-list variation-02 rbt-hover">
                            ...
                            <div className="rbt-card-body">
                                <h5 className="rbt-card-title">
                                    <a href="blog-details.html">Why Is Education So Famous?</a>
                                </h5>
                                <div className="rbt-card-bottom">
                                    <a className="transparent-button" href="blog-details.html">
                                        Read Article
                        ...
                        <div className="rbt-card card-list variation-02 rbt-hover mt--30">
                            ...
                            <div className="rbt-card-body">
                                <h5 className="rbt-card-title">
                                    <a href="blog-details.html">Difficult Things About Education.</a>
                                </h5>
                                <div className="rbt-card-bottom">
                                    <a className="transparent-button" href="blog-details.html">
                                        Read Article
                        ...
                        <div className="rbt-card card-list variation-02 rbt-hover mt--30">
                            ...
                            <div className="rbt-card-body">
                                <h5 className="rbt-card-title">
                                    <a href="blog-details.html">Education Is So Famous, But Why?</a>
                                </h5>
                                <div className="rbt-card-bottom">
                                    <a className="transparent-button" href="blog-details.html">
                                        Read Article
