                ...
                <div class="wrapper">
                    <div class="container">
                        <div class="row mb--60">
                            <div class="col-lg-12">
                                <div class="section-title text-center">
                                    <span class="subtitle bg-secondary-opacity">You Can Customize Everything </span>
                                    <h2 class="title">
                                        Take your Website to The <span class="theme-gradient"> Next Level!</span>
                                    </h2>
                                    <p class="description mt--20">An all-in-one template with powerful features.</p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row g-5">
                                        <div class="col-lg-4 col-md-12 col-sm-12 col-12 mt_md--30 mt_sm--30 order-2 order-lg-1">
                                            <div class="section-title text-start mb--60">
                                                <span class="subtitle bg-primary-opacity">All in One for Education </span>
                                                ...
                                                <ul class="nav nav-tabs splash-nav-tabs tab-button-list" id="splashLayoutTab" role="tablist">
                                                    <li class="nav-item active-nav" role="presentation">
                                                        ...
                                                        >
                                                            <div class="tab">
                                                                <h4 class="title">
                                                                    <img src="assets/images/splash/icons/online-course.png" alt="advance-tab-image" /> Courses Layout.
                                                                </h4>
                                                            </div>
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li class="nav-item" role="presentation">
                                                        ...
                                                        >
                                                            <div class="tab">
                                                                <h4 class="title">
                                                                    <img src="assets/images/splash/icons/header.png" alt="advance-tab-image" /> Header layout.
                                                                </h4>
                                                            </div>
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li class="nav-item" role="presentation">
                                                        ...
                                                        >
                                                            <div class="tab">
                                                                <h4 class="title">
                                                                    <img src="assets/images/splash/icons/curve.png" alt="advance-tab-image" /> Complete Design Toolkit.
                                                                </h4>
                                                            </div>
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li class="nav-item" role="presentation">
                                                        ...
                                                        >
                                                            <div class="tab">
                                                                <h4 class="title">
                                                                    <img src="assets/images/splash/icons/web-programming.png" alt="advance-tab-image" /> Infinitely Flexible
                                                                </h4>
                                                            </div>
                                                        </a>
                                                    </li>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <ul class="plan-offer-list d-block d-sm-flex justify-content-center">
                                    <li>
                                        <i class="feather-check"></i>Free future template updates
                                    </li>
                                    <li>
                                        <i class="feather-check"></i>Mix and Match Section Blocks
                                    </li>
                                    <li>
                                        <i class="feather-check"></i>Quality checked by Envato
                                    </li>
                                </ul>
                            </div>
                        </div>
