                        ...
                        <div class="col-lg-10 offset-lg-1 col-xl-6 offset-xl-3">
                            <div class="section-title text-center has-section-before-title mb--150 mt--50 mb_lg--100 mb_md--100 mb_sm--100">
                                ...
                                <h3 class="title">
                                    ...
                                    <span class="heading-opacity">Use any demo or template for education website. You can mix and match all the demos and templates.</span>
                                </h3>
                                <div class="indicator-icon">
                                    <img class="edu_bounce_loop" src="assets/images/icons/arrow-down.png" alt="arrow down icon" />
                                </div>
                                <p class="description has-medium-font-size mt--20">Create a complete education website with a lots of demo page and 250+ section blocks to create a unique site.</p>
                        ...
                        <div class="col-lg-12">
                            <div class="rbt-portfolio-filter filter-button-default messonry-button text-start justify-content-center mb--5 mb_md--30 mb_sm--30">
                                <button data-filter="*" class="is-checked">
                                    <span class="filter-text">All Demos</span>
                                    <span class="course-number">15</span>
                                </button>
                                <button data-filter=".marketplace" class="">
                                    <span class="filter-text">Marketplace</span>
                                    <span class="course-number">09</span>
                                </button>
                                <button data-filter=".university">
                                    <span class="filter-text">University</span>
                                    <span class="course-number">07</span>
                                </button>
                                <button data-filter=".instructor">
                                    <span class="filter-text">Instructor</span>
                                    <span class="course-number">06</span>
                                </button>
                                <button data-filter=".singlecourse">
                                    <span class="filter-text">Single Course</span>
                                    <span class="course-number">02</span>
                                </button>
                                <button data-filter=".career">
                                    <span class="filter-text">Career Trenning</span>
                                    <span class="course-number">09</span>
                                </button>
                            </div>
                        </div>
                                ...
                                <div class="maso-item marketplace career instructor">
                                    <div class="single-demo">
                                        <a class="single-demo-link" href="01-main-demo.html">
                                            ...
                                            <div class="content">
                                                <h3 class="title">
                                                    Main Demo <span class="label-new">Hot</span>
                                                </h3>
                                            </div>
                                        </a>
                                    </div>
                                ...
                                <div class="maso-item marketplace career">
                                    <div class="single-demo">
                                        <a class="single-demo-link" href="12-marketplace.html">
                                            ...
                                            <div class="content">
                                                <h3 class="title">
                                                    Marketplace <span class="label-new">Hot</span>
                                                </h3>
                                            </div>
                                        </a>
                                    </div>
                                ...
                                <div class="maso-item university">
                                    <div class="single-demo">
                                        <a class="single-demo-link" href="04-kindergarten.html">
                                            ...
                                            <div class="content">
                                                <h3 class="title">
                                                    Kindergarten <span class="label-new">Hot</span>
                                                </h3>
                                            </div>
                                        </a>
                                    </div>
                                ...
                                <div class="maso-item university">
                                    <div class="single-demo">
                                        <a class="single-demo-link" href="13-university-classic.html">
                                            ...
                                            <div class="content">
                                                <h3 class="title">
                                                    University Classic <span class="label-new">Hot</span>
                                                </h3>
                                            </div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="split-inner">
                                        ...
                                        <div class="plan-offer-list-wrapper">
                                            <ul class="plan-offer-list rbt-list-primary-opacity">
                                                <li>
                                                    <i class="feather-check"></i> LMS Admin UI/UX
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Lesson Types
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> User Profile
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Teacher Profile
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Student Profile
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Course With Tab
                                                </li>
                                            </ul>
                                            <ul class="plan-offer-list rbt-list-primary-opacity">
                                                <li>
                                                    <i class="feather-check"></i> Lesson Pages
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Single Page Variation
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Quick Action
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Filter the Courses
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Course Wishlist
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Course Ratings
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="row g-0 align-items-center">
                                <div class="col-lg-12 col-xl-6 col-12 order-2 order-xl-1">
                                    <div class="split-inner">
                                        ...
                                        <p class="description">
                                            Create event layouts, floor plans, event plans, and more with histudy. Get event layout templates, and more by our histudy template. You don't need to be a
                                            designer to create professional-looking results. Histudy event layout is perfect for event managemnt.
                                        </p>
                                        ...
                                        <div class="plan-offer-list-wrapper">
                                            <ul class="plan-offer-list rbt-list-primary-opacity">
                                                <li>
                                                    <i class="feather-check"></i> EMultiple Views
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Easy Events Classification
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Event Widgets
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Organizers & Venues
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Contact Organizer
                                                </li>
                                            </ul>
                                            <ul class="plan-offer-list rbt-list-primary-opacity">
                                                <li>
                                                    <i class="feather-check"></i> Google Maps
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Guest List
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Sell Tickets
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Attendee Information
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12 col-xl-6 col-12">
                                    <div class="split-inner">
                                        ...
                                        <div class="plan-offer-list-wrapper">
                                            <ul class="plan-offer-list rbt-list-primary-opacity">
                                                <li>
                                                    <i class="feather-check"></i> Pixel-Perfect Interface
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Perfect Product Layouts
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Single Product Variation
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Offcanvas for Mini Cart
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> One Page Checkout
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Wishlist Page
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="row g-0 align-items-center">
                                <div class="col-lg-12 col-xl-6 col-12 order-2 order-xl-1">
                                    <div class="split-inner">
                                        ...
                                        <p class="description">
                                            Have a nice blog layout for presentation your articles. You can choose from over available blog templates in histudy education template.
                                        </p>
                                        ...
                                        <div class="plan-offer-list-wrapper">
                                            <ul class="plan-offer-list rbt-list-primary-opacity">
                                                <li>
                                                    <i class="feather-check"></i> Blog List
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Blog Grid
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Blog Grid Minimal
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Blog With Sidebar
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Blog Details
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Post Format Standard
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Post Format Gallery
                                                </li>
                                            </ul>
                                            <ul class="plan-offer-list rbt-list-primary-opacity">
                                                <li>
                                                    <i class="feather-check"></i> Post Format Quote
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Post Format Audio
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Post Format Video
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Media Under Title <span class="rbt-badge-card">Coming</span>
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Sticky Sidebar <span class="rbt-badge-card">Coming</span>
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Auto Masonry <span class="rbt-badge-card">Coming</span>
                                                </li>
                                                <li>
                                                    <i class="feather-check"></i> Meta Overlaid <span class="rbt-badge-card">Coming</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
